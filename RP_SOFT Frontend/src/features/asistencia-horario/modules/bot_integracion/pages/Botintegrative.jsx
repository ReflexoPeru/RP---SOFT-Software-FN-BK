...
const serverData = [
  { id: 1, name: 'RPSOTF', members: 89, channels: 30, icon: <Server size={18} />, color: 'blue' },
  { id: 2, name: 'Innovacion', members: 47, channels: 12, icon: <Server size={18} />, color: 'green' },
  { id: 3, name: 'Recuperacion', members: 1, channels: 3, icon: <Smartphone size={18} />, color: 'pink' },
  { id: 4, name: 'Minibootcamp', members: 0, channels: 2, icon: <Users size={18} />, color: 'orange' },
  { id: 5, name: 'Laboratorios', members: 87, channels: 15, icon: <Users size={18} />, color: 'orange' },
];
